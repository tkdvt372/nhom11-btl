    ...
    <div id="container">
        ...
        <div id="header" style="height:90;border:1px solid gray">
         <img src="image/entraitim.jpg" id="icon" style=" margin-left:20px;margin-top:10;border:1px solid black" height="70" width=70>
            ...
            <form action="TkMonAn1.php" method="POST">
        ...
        <div id="kmhn">
             ...
             <?php 
                ...
                <li >
                    <div class="class1" >
                    <a href="sanpham2.php?ma=<?php echo$row["mahang"] ?>"><img style="border:2px solid gray"    src="image/<?php echo $row["anh"] ?>" alt="" width=240 height=140></a>
        ...
        <div id="content">
           <div class="left">
               ...
               <?php 
                ...
                <li>
                    <div class="class1">
                    <a href="sanpham2.php?ma=<?php echo $row1["mahang"]?>"><img style="border:2px solid gray" src="image/<?php echo $row1["anh"] ?>" alt="" width=230 height=130></a>
        ...
        ?>
               ...
               <?php 
                ...
                <li>
                    <div class="class1">
                    <a href="sanpham2.php?ma=<?php echo $row2["mahang"] ?>"><img style="border:2px solid gray" src="image/<?php echo $row2["anh"] ?>" alt="" width=230 height=130></a>
...
<br>
        ...
        <a href="sanpham2.php?ma=<?php echo $row["mahang"] ?>"><img style="border:2px solid gray" src="image/<?php echo $row["anh"] ?>" alt=""  width=160 height=120></a>
