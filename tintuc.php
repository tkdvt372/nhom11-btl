...
<body>
    ...
    <div id="header" style="height:90;border:1px solid gray">
        ...
        <div id="menu">
            <ul>
                <li style="margin-left: 170px;"><a href="index1.php?tk=<?php echo $taikhoan ?>"><span class="fa fa-home"> Trang chủ</span></a></li>
                <li style="margin-left: 170px;"><a href=""><span class="fa fa-percent"> Sản Phẩm</span></a>
                </li>
                <li style="margin-left: 170px;"><a href="index1.php?tk=<?php echo $taikhoan ?>"><span class="fa fa-rss"> Tin tức</span></a></li>
                <li style="margin-left: 170px;"><a href="gioithieu.php?tk=<?php echo $taikhoan ?>"><span class="fa fa-address-card"> Giới thiệu</span></a></li>
